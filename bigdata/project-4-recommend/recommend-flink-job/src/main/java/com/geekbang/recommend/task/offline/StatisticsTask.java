...
//
//import com.geekbang.recommend.sink.HbaseSink;
...
//        Table table = benv.fromDataSet(dataSet, "f0, f1, f2, f3").renameColumns(new SqlCallExpression("f0 as userId, f1 as productId, f2 as score, f3 as timestamp"));
...
//        Table table = benv.fromDataSet(source).renameColumns(new SqlCallExpression("f0 as productId, f1 as score, f2 as yearmonth"));
