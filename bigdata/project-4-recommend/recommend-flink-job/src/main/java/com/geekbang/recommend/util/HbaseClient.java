...
//        conf.set("hbase.rootdir", Property.getStrValue("hbase.rootdir"));
        ...
        conf.set("hbase.config.hbase.zookeeper.property.clientPort",Property.getStrValue("hbase.zookeeper.port"));
    ...
    public static void putData(String tablename, String rowkey, String famliyname,String column,String data) throws Exception {
        log.info("准备添加数据,[tablename:{},familyName:{}],key:{}.column:{},data:{}",tablename,famliyname,rowkey,column,data);
        Table table = conn.getTable(TableName.valueOf(tablename));
        Put put = new Put(rowkey.getBytes());
        put.addColumn(famliyname.getBytes(),column.getBytes(),data.getBytes());
        table.put(put);
        log.info("写入成功数据,[tablename:{},familyName:{}],key:{}.column:{},data:{}",tablename,famliyname,rowkey,column,data);
